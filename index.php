            ...
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <h5 class="h5 mt-2"><i class="bi bi-pencil-fill"></i> DISEÑO</h5>
            ...
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <h5 class="h5 mt-2"><i class="bi bi-flower1"></i>DESARROLLO</h5>
            ...
            <div class="col-sm-12 col-md-4">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <h5 class="h5 mt-2"><i class="bi bi-airplane"></i> EDICIÓN DE LIBROS</h5>
